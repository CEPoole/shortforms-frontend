...
class ChildBenefitControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val childBenefitRoute = routes.ChildBenefitController.onPageLoad(NormalMode).url
  ...
  "ChildBenefit Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(ChildBenefitPage, true).success.value
